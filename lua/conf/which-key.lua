...
function M.setup()
    ...
    local mapping_normal_mode = {
        ...
        h = {
            name = "+Hop",
            l = { "<cmd>lua require('hop').hint_patterns({direction = require('hop.hint').HintDirection.AFTER_CURSOR,  current_line_only = true})<cr>",
                "Search Left Part", },
            h = { "<cmd>lua require('hop').hint_patterns({direction = require('hop.hint').HintDirection.BEFORE_CURSOR, current_line_only = true})<cr>",
                "Search Right Part", },
            j = { "<cmd>lua require('hop').hint_patterns({direction = require('hop.hint').HintDirection.AFTER_CURSOR,  current_line_only = false})<cr>",
                "Search Below Part", },
            k = { "<cmd>lua require('hop').hint_patterns({direction = require('hop.hint').HintDirection.BEFORE_CURSOR, current_line_only = false})<cr>",
                "Search Upper Part", },
        },
        l = {
            name = "+Lsp",
